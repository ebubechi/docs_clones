...
import 'package:flutter_app/constants/colors.dart';
import 'package:flutter_app/models/document_model.dart';
import 'package:flutter_app/models/error_model.dart';
import 'package:flutter_app/repository/auth_repository.dart';
import 'package:flutter_app/repository/document_repository.dart';
import 'package:flutter_app/repository/socket_repository.dart';
    ...
    _controller!.document.changes.listen((event) {
      ...
      if (event.source == quill.ChangeSource.LOCAL) {
        Map<String, dynamic> map = {
          'delta': event.change, // event.item2
          'room': widget.id,
        };
